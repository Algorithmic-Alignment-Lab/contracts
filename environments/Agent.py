...
from environments import env_utils as util
...
class Agent(object):
    def __init__(self, agent_id, start_pos, start_orientation, full_map, row_size, col_size):
        ...
        self.list_pos = list(start_pos)
        self.orientation = start_orientation
        self.int_orientation = ORIENTATION_MAP[start_orientation]
    ...
    def set_orientation(self, new_orientation):
        ...
        self.int_orientation = ORIENTATION_MAP[new_orientation]
...
CLEANUP_ACTIONS.update({8: "FIRE", 7: "CLEAN"})  # Fire a penalty beam  # Fire a cleaning beam
